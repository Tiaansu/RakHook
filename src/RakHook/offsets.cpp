...
constexpr std::uintptr_t samp_info[]           = {0x21a0f8, 0x21a100, 0x26e8dc, 0x26ea0c, 0x26eb94, 0x2aca24};
constexpr std::uintptr_t rakclient_interface[] = {0x3c9, 0x18, 0x2c, 0x2c, 0x0, 0x2c};
constexpr std::uintptr_t destroy_interface[]   = {0x342d0, 0x343b0, 0x37680, 0x37d70, 0x37dc0, 0x37880};
constexpr std::uintptr_t handle_rpc_packet[]   = {0x372f0, 0x373d0, 0x3a6a0, 0x3ad90, 0x3ade0, 0x3a8a0};
constexpr std::uintptr_t alloc_packet[]        = {0x347e0, 0x348c0, 0x37b90, 0x38280, 0x382d0, 0x37d90};
constexpr std::uintptr_t offset_packets[]      = {0xdb6, 0xdb6, 0xdb6, 0xdb6, 0xdb6, 0xdb6};
constexpr std::uintptr_t write_lock[]          = {0x35b10, 0x35bf0, 0x38ec0, 0x395b0, 0x39600, 0x390c0};
constexpr std::uintptr_t write_unlock[]        = {0x35b50, 0x35c30, 0x38f00, 0x395f0, 0x39640, 0x39100};
